...
async def yt_search(hindu):
    try:
        hindu = urllib.parse.quote(hindu)
        html = urllib.request.urlopen(
            "https://www.youtube.com/results?search_query=" + hindu
        )
...
async def yt_data(hindu):
    params = {"format": "json", "url": hindu}
