...
async def hindu_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def hindu_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
