...
from . import edit_or_reply, hinduub
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}getc 10 @HINDUS_USERBOT",
    },
)
async def get_media(event):
    hinduty = event.pattern_match.group(1)
    limit = int(hinduty.split(" ")[0])
    channel_username = str(hinduty.split(" ")[1])
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}geta @HINDUS_USERBOT",
    },
)
async def get_media(event):
