...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}create b HINDUS USERBOT",
    },
)
async def _(event):
    ...
    if type_of_group == "c":
        descript = "This is a Test Channel created using HINDUS USERBOT"
    else:
        descript = "This is a Test Group created using HINDUS USERBOT"
    if type_of_group == "g":
        try:
