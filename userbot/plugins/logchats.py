# pm and tagged messages logger for HINDUS USERBOT by @HINDUS_USERBOT (@HINDUS_USERBOT)
import asyncio
...
@hinduub.hindu_cmd(incoming=True, func=lambda e: e.mentioned, edited=False, forword=None)
