...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "usage": "{tr}ss <link>",
        "examples": "{tr}ss https://github.com/OFFICIAL-SAMEER/HINDUS USERBOT",
    },
)
async def _(event):
    ...
    try:
        ...
        inputstr = input_str
        if cmd == "ss":
            hinduurl = url(inputstr)
            if not hinduurl:
                inputstr = "http://" + input_str
                hinduurl = url(inputstr)
            if not hinduurl:
                return await hinduevent.edit("`The given input is not supported url`")
        if cmd == "gis":
            inputstr = "https://www.google.com/search?q=" + input_str
        driver.get(inputstr)
        await hinduevent.edit("`Calculating Page Dimensions`")
        ...
        await hinduevent.edit("`Stoppping Chrome Bin`")
        driver.close()
        ...
        await hinduevent.edit(f"`{traceback.format_exc()}`")
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}scapture https://github.com/OFFICIAL-SAMEER/HINDUS USERBOT",
    },
)
async def _(event):
    "To Take a screenshot of a website."
    ...
    if "image" in contentType:
        with io.BytesIO(response_api.content) as screenshot_image:
            ...
            try:
                ...
                await hinduevent.edit(str(e))
    else:
        await hinduevent.edit(f"`{response_api.text}`")
