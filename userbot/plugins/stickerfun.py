...
async def sticklet(event):
    ...
    fontsize = 230
    FONT_FILE = await get_font_file(event.client, "@hindufonts", font_file_name)
    ...
    image_stream.name = "HINDUS USERBOT.webp"
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}twt HINDUS USERBOT",
    },
)
async def twt(event):
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}googl HINDUS USERBOT",
    },
)
async def twt(event):
