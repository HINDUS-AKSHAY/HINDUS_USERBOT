...
# button post makker for HINDUS USERBOT thanks to uniborg for the base
...
from . import edit_delete, hinduub, reply_id
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [HINDUS USERBOT]<buttonurl:https://t.me/HINDUS_USERBOT:same> [support]<buttonurl:https://t.me/HINDUS_USERBOT_SUPPORT>",
    },
)
async def _(event):
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test [google]<buttonurl:https://www.google.com> [HINDUS USERBOT]<buttonurl:https://t.me/HINDUS_USERBOT:same> [support]<buttonurl:https://t.me/HINDUS_USERBOT_SUPPORT>",
    },
)
async def _(event):
    ...
    if not markdown_note:
        return await edit_delete(event, "`what text should i use in button post`")
    hinduinput = "Inline buttons " + markdown_note
    results = await event.client.inline_query(Config.TG_BOT_USERNAME, hinduinput)
