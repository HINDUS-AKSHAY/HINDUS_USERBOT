...
from . import deEmojify, edit_or_reply, hinduub
...
async def carbon_api(event):
    ...
    hindu = await edit_or_reply(event, "`Carbonizing...\n25%`")
    ...
    await hindu.edit("`Processing..\n75%`")

    await asyncio.sleep(2)
    await hindu.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await hindu.edit("`Uploading..`")
...
async def carbon_api(event):
    """A Wrapper for carbon.now.sh"""
    hindu = await edit_or_reply(event, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await event.get_reply_message()
    pcode = event.text
    if pcode[5:]:
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)
    await hindu.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
    chrome_options.binary_location = Config.CHROME_BIN
...
async def carbon_api(event):
    """A Wrapper for carbon.now.sh"""
    hindu = await edit_or_reply(event, "🔲🔲🔲🔲🔲")
    ...
    await hindu.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await hindu.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
        force_document=True,
...
async def carbon_api(event):
    ...
    await hindu.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await hindu.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await hindu.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await hindu.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await hindu.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await hindu.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await hindu.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await hindu.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
