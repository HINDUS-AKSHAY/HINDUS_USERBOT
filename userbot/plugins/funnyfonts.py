...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}str HINDUS USERBOT",
    },
)
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}zal HINDUS USERBOT",
    },
)
async def zal(zgfy):
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}weeb HINDUS USERBOT",
    },
)
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}downside HINDUS USERBOT",
    },
)
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}subscript HINDUS USERBOT",
    },
)
async def stylish_generator(event):
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}superscript HINDUS USERBOT",
    },
)
async def stylish_generator(event):
