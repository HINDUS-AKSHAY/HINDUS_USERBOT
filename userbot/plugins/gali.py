...
from . import hindumemes, hinduub
...
async def abusing(abused):
    "random abuse string"
    reply_text = random.choice(hindumemes.ABUSE_STRINGS)
...
async def fuckedd(abusehard):
    "random gali string"
    reply_text = random.choice(hindumemes.ABUSEHARD_STRING)
...
async def metoo(e):
    "random gali string"
    txt = random.choice(hindumemes.RENDISTR)
...
async def chutiya(fuks):
    "random gali string"
    reply_text = random.choice(hindumemes.CHU_STRINGS)
...
async def thanos(thanos):
    "random gali string"
    reply_text = random.choice(hindumemes.THANOS_STRINGS)
...
async def _(event):
    "fun animation"
    hinduevent = await edit_or_reply(event, "`kiss`")
    animation_interval = 0.2
    animation_ttl = range(100)
    animation_chars = ["🤵       👰", "🤵     👰", "🤵  👰", "🤵💋👰"]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await hinduevent.edit(animation_chars[i % 4])
...
async def _(event):
    "fun animation"
    hinduevent = await edit_or_reply(event, "`fuking....`")
    animation_interval = 0.2
    animation_ttl = range(100)
...
async def _(event):
    "fun animation"
    hinduevent = await edit_or_reply(event, "`sex`")
    animation_interval = 0.2
    animation_ttl = range(100)
    animation_chars = ["🤵       👰", "🤵     👰", "🤵  👰", "🤵👼👰"]
    for i in animation_ttl:
