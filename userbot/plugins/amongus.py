...
async def amongus_gen(text: str, clr: int) -> str:
    url = "https://github.com/OFFICIAL-SAMEER/HINDUS USERBOT-Resources/raw/master/Resources/Amongus/"
    font = ImageFont.truetype(
        BytesIO(
            get(
                "https://github.com/OFFICIAL-SAMEER/HINDUS USERBOT-Resources/raw/master/Resources/fonts/bold.ttf"
            ).content
        ),
        60,
    )
...
async def get_imposter_img(text: str) -> str:
    background = get(
        f"https://github.com/OFFICIAL-SAMEER/HINDUS USERBOT-Resources/raw/master/Resources/imposter/impostor{randint(1,22)}.png"
    ).content
    font = get(
        "https://github.com/OFFICIAL-SAMEER/HINDUS USERBOT-Resources/raw/master/Resources/fonts/roboto_regular.ttf"
    ).content
    font = BytesIO(font)
...
async def _(event):
    ...
    hinduevent = await event.reply(f"{name} is ejected.......")
    await asyncio.sleep(2)
    await hinduevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await hinduevent.edit("ㅤඞㅤㅤㅤㅤ ㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await hinduevent.edit("ㅤㅤ ඞㅤㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await hinduevent.edit("ㅤㅤㅤ ඞㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await hinduevent.edit("ㅤㅤㅤㅤ ඞㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await hinduevent.edit("ㅤㅤㅤㅤㅤ ඞㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await hinduevent.edit("ㅤㅤㅤㅤㅤㅤ ඞㅤㅤ")
    await asyncio.sleep(0.5)
    await hinduevent.edit("ㅤㅤㅤㅤㅤㅤㅤ ඞㅤ")
    await asyncio.sleep(0.5)
    await hinduevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ඞ")
    await asyncio.sleep(0.5)
    await hinduevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ㅤ")
...
async def _(event):
    ...
    name = event.pattern_match.group(2)
    cmd = event.pattern_match.group(1).lower()
    hinduevent = await edit_or_reply(event, f"{name} is ejected.......")
    await asyncio.sleep(2)
    await hinduevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
