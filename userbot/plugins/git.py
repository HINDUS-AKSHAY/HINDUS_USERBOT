...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/OFFICIAL-SAMEER/HINDUS USERBOT) to open this bot source code\
        \nClick [here](https://github.com/OFFICIAL-SAMEER/HINDUS USERBOT) to open supported link for heroku",
    )
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": [".github HINDUS_USERBOT", ".github -l5 HINDUS_USERBOT"],
    },
)
async def _(event):
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(URL) as request:
            ...
            hinduevent = await edit_or_reply(event, "`fetching github info ...`")
