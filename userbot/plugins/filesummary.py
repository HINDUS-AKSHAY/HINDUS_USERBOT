# file summary plugin for HINDUS USERBOT  by @HINDUS_USERBOT
import time
...
@hinduub.hindu_cmd(
    ...
    info={
        ...
        "examples": "{tr}chatfs @HINDUS_USERBOT_SUPPORT",
    },
)
async def _(event):  # sourcery no-metrics
    ...
    await hinduevent.edit(result, parse_mode="HTML", link_preview=False)
